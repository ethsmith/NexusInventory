...
public class PlayerSerialization {
     ...
     */
    public static JSONObject serializePlayer(Player player, NexusInventory plugin) {
        try {
     ...
     */
    public static String serializePlayerAsString(Player player, NexusInventory plugin) {
     ...
     * @return The serialization string
     */
    public static String serializePlayerAsString(Player player, boolean pretty, NexusInventory plugin) {
     ...
     * @return The serialization string
     */
    public static String serializePlayerAsString(Player player, boolean pretty, int indentFactor, NexusInventory plugin) {
        try {
            if (pretty) {
     ...
     */
    public static void setPlayer(String meta, Player player, NexusInventory plugin) {
        try {
     ...
     * @param player The affected player
     */
    public static void setPlayer(JSONObject meta, Player player, NexusInventory plugin) {
        try {
            // Formats: 0 == old serialization, 1 == new serialization
            int format = 0;
